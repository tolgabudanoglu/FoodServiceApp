...
import com.example.foodservice2.databinding.FavoriteRecipesRowLayoutBinding
import com.example.foodservice2.ui.fragments.favorites.FavoriteRecipesFragmentDirections
...
class FavoriteRecipesAdapter(
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.FavoriteRecipesRowLayout.setOnClickListener {
            if (multiSelection){
                ...
                val action =
                    FavoriteRecipesFragmentDirections.actionFavoriteRecipesFragmentToDetailsActivity(currentRecipes.result)
    ...
    override fun onActionItemClicked(actionMode: ActionMode?, menu: MenuItem?): Boolean {
        if (menu?.itemId == R.id.deleteFavoriteRecipeMenu) {
